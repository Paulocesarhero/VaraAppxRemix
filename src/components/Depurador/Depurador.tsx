...
const Depurador: React.FC = () => {
  ...
  /*   este es un componente que me sirvio para depurar funciones de react native como por ejemplo el uso de imagenes en
     react native o la conexión de bases de datos antes de que implementara drizzle studio al proyecto, espero que al futuro programador le pueda servir, talvez es una mala practica pero
     realmente el desarrollo multiplataforma es algo muy desafiante y dejare esto por aqui para alguien en la posterioridad
     @Paulo Cesar Hernandez Rosado pd: Suerte ingeniero de software :)
 */
  return (
